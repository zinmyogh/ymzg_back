<template>
  <div class="app-container">
    <el-card>
      ...
      <el-table :data="funds.tableData" element-loading-text="Loading" border fit highlight-current-row>
        <el-table-column prop="userId" label="用户ID" align="center" />
        <el-table-column prop="name" label="用户账号" align="center" />
        <el-table-column prop="score" label="资产积分(￥)" align="center" />
...
export default {
  ...
  computed: {
    ...mapState({ funds: state => state.md.FundList })
  },
  created() {
    // this.getAmount()
  },
  methods: {
    doFind() {
      ...
      this.$store.commit('md/setFundList', setdata)
      const reqt = {
        router: 'getFunds',
        JsonData: {
          ...
          startTime: moment(this.date1[0]).format("YYYY-MM-DD hh:mm:ss"),
          endTime: moment(this.date1[1]).format("YYYY-MM-DD hh:mm:ss")
        }
      }
      // console.log('getFunds5 .... ', reqt)
